...
CSSPrimer takes in a markup file or recusively checks a folder for any.
It then generates a css file with all the extracted ids and classes.
...
== Using Examples
  ...
  ruby bin/css_primer --in examples/
